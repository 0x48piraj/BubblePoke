...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gamePane.addJavascriptInterface(this, "HTMLOUT");
        gamePane.loadData("\n" +
    ...
    public void endGame(int n, int acc)
    {
